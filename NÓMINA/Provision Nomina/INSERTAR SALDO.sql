...
WHERE Sucursal.IdSucursal > 0 AND Auxiliar.IdAuxiliar = @IdAuxiliar AND AuxAsignados.EsDeudor = CASE WHEN Auxiliar.Naturaleza = 1 THEN 1
                                                                                                     ELSE 0
                                                                                                END AND Empleado.IdEmpleado IN ( 73 ) AND (Saldo.IdSaldo IS NULL OR Saldo.IdEstatus = 1);
GO
