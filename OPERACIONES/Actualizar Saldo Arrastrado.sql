...
INNER JOIN( SELECT IdSaldoDestino,
                   ...
                   SaldoCapital = SUM (CapitalGenerado - CapitalPagado) OVER ( PARTITION BY IdCuenta
                                                                               ORDER BY Fecha,
                                                                                        IdTransaccion ),
                   SaldoAnterior = SUM (CapitalGenerado - CapitalPagado + InteresOrdinarioDevengado - InteresOrdinarioPagado + InteresAcapitalizar - InteresCapitalizado - InteresRetirado) OVER ( PARTITION BY IdCuenta
                                                                                                                                                                                                   ORDER BY Fecha,
                                                                                                                                                                                                            IdTransaccion )
                   ...
                   CambioNeto = CapitalGenerado - CapitalPagado + InteresOrdinarioDevengado - InteresOrdinarioPagado + InteresAcapitalizar - InteresCapitalizado - InteresRetirado,
                   Saldo = SUM (CapitalGenerado - CapitalPagado + InteresOrdinarioDevengado - InteresOrdinarioPagado + InteresAcapitalizar - InteresCapitalizado - InteresRetirado) OVER ( PARTITION BY IdCuenta
                                                                                                                                                                                           ORDER BY Fecha,
                                                                                                                                                                                                    IdTransaccion )
